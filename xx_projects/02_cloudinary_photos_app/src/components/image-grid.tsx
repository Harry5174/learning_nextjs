  ...
  if (images.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-lg font-semibold text-slate-600 dark:text-slate-400 mb-2">No images found</h3>
        <p className="text-slate-500 dark:text-slate-500">Try uploading some photos or adjusting your search.</p>
      </div>
    );
  }
